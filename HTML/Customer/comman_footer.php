...
<section id="footer-part">
  <div class="container-fluid footer" >
    <div class="row" style="margin:0px !important;">
      ...
      <div class="col-sm-3 col-md-3 col-lg-3 footer_media_icon">
        <a href=#><img src="imges/fb.png" class="footer_media_logo"></a>
        <a href=#><img src="imges/insta.png" class="footer_media_logo"></a>
      </div>
    </div>
    <div class="hr_div"><hr class="hr_line"></div>

    <div class="footer_policy_div">
      <p class="footer_policy_p">©2018 Helperland. All rights reserved. <a href=# class="footer_policy_p_a">Terms and Conditions</a> | <a href=# class="footer_policy_p_a">Privacy Policy</a></p>
    </div>
  </div>
</section>
<!-- Footer Ends -->